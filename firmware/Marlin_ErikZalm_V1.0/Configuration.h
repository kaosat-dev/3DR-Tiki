...
#define STRING_CONFIG_H_AUTHOR "(mmoissette, 3DR_T)" // Who made the changes.
...
#define DELTA_DIAGONAL_ROD 194.0 // mm
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {XYZ_STEPS, XYZ_STEPS, XYZ_STEPS, 280}  // default steps per unit for Kossel (GT2, 20 tooth)
